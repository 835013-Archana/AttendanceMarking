...
<body>
    ...
    <div class="index-icons">
        <nav> <a href="admin-login.jsp"><i class="fas fa-user-alt icons"
            aria-hidden="true"></i>&nbsp;&nbsp;<b>ADMIN</b></a> <a id="user" href="user-login.jsp"><i
            class="fas fa-user-alt icons1" aria-hidden="true"></i> <b>USER</b></a> </nav>
    </div>
    </header>
    <div id="logo">
