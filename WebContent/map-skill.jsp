...
<body id="admin">
    ...
    <div class="skill-container">
        <form name="attendance" action="UpdateMapSkill" autocomplete="off"
            onsubmit="return validateMapSkillForm()" method="post">
            <table cellspacing="35">
                <h3 align="center">Map Skill</h3>
                <tr>
                    <td><label for="skill-id"><b>Skill ID </b></label></td>
                    <td><select name="skillId" id="skill-id">
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" id="button" value="Map Skill" /></td>
                </tr>
            </table>
        </form>
    </div>
