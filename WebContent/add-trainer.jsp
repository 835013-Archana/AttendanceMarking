...
<body id="admin">
    ...
    <div class="container">
        <form action="AddTrainerDetails" method="post">
            <table cellspacing="35">
                <tr>
                    <td><label for="trainer-id"><b>Trainer ID </b></label></td>
                    <td><input type="text" id="trainer-id" name="trainerId" /></td>
                </tr>
                <tr>
                    <td><label for="trainer-name"><b>Trainer Name</b></label></td>
                    <td><input type="text" id="trainer-name" name="trainerName" /></td>
                </tr>
                <tr>
                    <td><label for="contact-number"><b>Contact Number</b></label></td>
                    <td><input type="text" id="contact-number" name="contactNumber" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="skill-set" name="skillId" /></td>
                </tr>
                <tr>
                    <td></td>
